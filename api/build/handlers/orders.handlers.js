...
exports.getOneUserComplete = exports.getOneUser = exports.deleteOne = exports.updateOne = exports.getOne = exports.getAll = exports.create = void 0;
...
var getOne = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderModel.getOne(req.params.id)];
            case 1:
                order = _a.sent();
                res.json({
                    message: 'Done!',
...
var updateOne = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderModel.updateOne(req.body)];
            case 1:
                order = _a.sent();
                res.json({
                    message: 'Done!',
...
var deleteOne = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderModel.deleteOne(req.params.id)];
            case 1:
                order = _a.sent();
                res.json({
                    message: 'Done!',
...
var getOneUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderModel.getOneUser(req.params.id)];
            case 1:
                order = _a.sent();
                res.json({
                    message: 'Done!',
...
var getOneUserComplete = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order, error_7;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderModel.getOneUserComplete(req.params.id)];
            case 1:
                order = _a.sent();
                res.json({
                    message: 'Done!',
...
exports.getOneUserComplete = getOneUserComplete;
