...
exports.authenticateOne = exports.deleteOne = exports.updateOne = exports.getOne = exports.getAll = exports.create = void 0;
...
var deleteOne = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userModel.deleteOne(req.params.id)];
            case 1:
                user = _a.sent();
                res.json({
                    message: 'Delete Done!',
...
var authenticateOne = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, JWT, error_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userModel.authenticateOne(req.body.userName, req.body.password)];
            case 1:
                user = _a.sent();
...
exports.authenticateOne = authenticateOne;
