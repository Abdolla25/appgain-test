...
exports.deleteOne = exports.updateOne = exports.getOne = exports.getAll = exports.create = void 0;
...
var getAll = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productModel.getAll()];
            case 1:
                product = _a.sent();
                res.json({
                    message: 'Done!',
...
var updateOne = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productModel.updateOne(req.body)];
            case 1:
                product = _a.sent();
                res.json({
                    message: 'Done!',
...
var deleteOne = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productModel.deleteOne(req.params.id)];
            case 1:
                product = _a.sent();
                res.json({
                    message: 'Done!',
