...
var ProductModel = /** @class */ (function () {
    ...
    ProductModel.prototype.updateOne = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "UPDATE products SET id=$1, name=$2, Price=$3 WHERE id=$1 returning *;";
                        return [4 /*yield*/, conn.query(sql, [product.id, product.name, product.Price])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows[0]];
