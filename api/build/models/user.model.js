...
var hash = function (password) {
    var salt = parseInt(config_1.SALT_ROUNDS);
    return bcrypt_1.default.hashSync("".concat(password).concat(config_1.BCRYPT_PASSWORD), salt);
};
var UserModel = /** @class */ (function () {
    ...
    UserModel.prototype.updateOne = function (user) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    UserModel.prototype.authenticateOne = function (userName, password) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, hash_1, passwordCheck, user, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 2:
                        ...
                        passwordCheck = bcrypt_1.default.compareSync("".concat(password).concat(config_1.BCRYPT_PASSWORD), hash_1);
                        if (!passwordCheck) return [3 /*break*/, 4];
                        return [4 /*yield*/, conn.query("SELECT * FROM users WHERE userName=($1)", [userName])];
                    case 3:
                        user = _a.sent();
