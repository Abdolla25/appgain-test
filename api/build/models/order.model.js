...
var OrderModel = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "INSERT INTO orders (OrderStatus, uid) VALUES ($1, $2) returning *;";
                        return [4 /*yield*/, conn.query(sql, [order.OrderStatus, order.uid])];
                    case 2:
                        result = _a.sent();
                        conn.release();
    ...
    OrderModel.prototype.updateOne = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "UPDATE orders SET id=$1, OrderStatus=$2, uid=$3 WHERE id=$1 returning *;";
                        return [4 /*yield*/, conn.query(sql, [order.id, order.OrderStatus, order.uid])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows[0]];
    ...
    OrderModel.prototype.getOneUser = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "SELECT * FROM orders WHERE uid=$1 AND OrderStatus=1";
                        return [4 /*yield*/, conn.query(sql, [id])];
                    case 2:
                        result = _a.sent();
                        conn.release();
    ...
    OrderModel.prototype.getOneUserComplete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "SELECT * FROM orders WHERE uid=$1 AND OrderStatus=2";
                        return [4 /*yield*/, conn.query(sql, [id])];
                    case 2:
                        result = _a.sent();
                        conn.release();
